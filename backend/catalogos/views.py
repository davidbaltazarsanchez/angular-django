...
def autenticar_ad(usuario, password):
    ...
    try:
        ...
        return response.json()  # debería ser true o false
...
def subir_excel(request):
    ...
    try:
        ...
        print("Excel: ", columnas_excel, flush=True)
        print("Faltantes: ", faltantes_estructura, flush=True)
        print("Extra: ", extras, flush=True)
